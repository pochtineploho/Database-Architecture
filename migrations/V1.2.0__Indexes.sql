...
CREATE INDEX IF NOT EXISTS idx_collection_headers_collection_id ON CollectionHeaders (collection_id);
CREATE INDEX IF NOT EXISTS idx_collection_details_product_id ON CollectionDetails (product_id);